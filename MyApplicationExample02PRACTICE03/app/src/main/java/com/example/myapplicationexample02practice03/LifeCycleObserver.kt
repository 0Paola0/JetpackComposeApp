package com.example.myapplicationexample02practice03
...
class LifeCycleObserver (private val activity: Activity,
                         private val txtAbierto: TextView,
                         private val txtSuspendido: TextView,
                         private val txtCerrado: TextView,
                         private val txtEstado: TextView) : DefaultLifecycleObserver {
    ...
    override fun onStart(owner: LifecycleOwner) {
        ...
        txtEstado.text = "Current state: onStart"
